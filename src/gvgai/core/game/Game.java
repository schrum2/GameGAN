...
import gvgai.core.content.Content;
import gvgai.core.content.GameContent;
import gvgai.core.content.ParameterContent;
import gvgai.core.content.SpriteContent;
import gvgai.core.game.GameDescription.InteractionData;
import gvgai.core.game.GameDescription.SpriteData;
import gvgai.core.game.GameDescription.TerminationData;
import gvgai.core.logging.Logger;
import gvgai.core.logging.Message;
import gvgai.core.player.Player;
import gvgai.core.termination.Termination;
import gvgai.core.vgdl.SpriteGroup;
...
import gvgai.ontology.effects.TimeEffect;
import gvgai.ontology.sprites.Resource;
import gvgai.tools.*;
import gvgai.tools.pathfinder.Node;
import gvgai.tools.pathfinder.PathFinder;
...
public abstract class Game {
	...
	public double[] playGame(Player[] players, int randomSeed, boolean isHuman, int humanID) {
		...
		for (Player player : players)
			if (player instanceof gvgai.tracks.singlePlayer.tools.human.Agent) {
