...
public class Art
{
    ...
    final static String img = curDir + "/data/mario/img/";
...
//            System.out.println(curDir);
    ...
    private static Image getImage(GraphicsConfiguration gc, String imageName) throws IOException
    {
        ...
        // Schrum: This code looks for the images in the wrong location.
        // They are in the resources subdirectory. It is sloppy to check
        // here first since it throws an exception.
//        try {
